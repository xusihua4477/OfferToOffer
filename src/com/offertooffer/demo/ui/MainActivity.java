...
public class MainActivity extends ActivityBase implements EventListener{
	...
	private void initTab(){
		...
		fragments = new Fragment[] {recentFragment, contactFragment, settingFragment,zhaopinListFragment };
		// 添加显示第一个fragment
		getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, recentFragment).hide(recentFragment).add(R.id.fragment_container, zhaopinListFragment).hide(zhaopinListFragment).
			add(R.id.fragment_container, contactFragment).hide(contactFragment).show(zhaopinListFragment).commit();
	}
